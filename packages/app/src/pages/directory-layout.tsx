...
import { fileResultToBlob, filenameFromPath, triggerBrowserDownload, type FileReadResult } from "@/utils/download"
...
function DirectoryDataProvider(props: ParentProps<{ directory: string }>) {
  ...
  const downloadFile = (path: string) => {
    sdk.client.file.read({ path }).then((x) => {
      ...
      showToast({ variant: "error", title: language.t("toast.file.downloadFailed.title") })
    })
  }
